...
if(isset($_POST['change_password'])){
            ...
            $user_email = $_SESSION['user_email'];
              ...
              //No error
                ...
                $stmt->bind_param('ss',$passwordHash,$user_email);
              ...
              <td>
                ...
                <td>
                  <form method="POST" action="order_details.php">
                    ...
                    <input class="order-details-btn" name="order_details_btn" type="submit" value="details">
                  </form>
                </td>
